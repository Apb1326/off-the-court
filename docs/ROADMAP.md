...
| 2b | **S2c1 — candidate tendencies + evaluation seam** | S | **NEXT.** Derive real usage/play-type/shot-mix tendencies beside the active pool and add a read-only candidate profiling path. |
