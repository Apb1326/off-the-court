...
> **Status:** living master plan, **revision 8 + S2c1-R acceptance addendum (2026-07-10)**, verified at `29ad959` plus the current working diff. Save schema **v7**; transactions **Phases 1–5b implemented**; Stage 1 accepted; F1 done; and **S2a, S2b, S2b-R, S2c1, and S2c1-R landed**. The pipeline-derived candidate league remains inactive: **S2c2 is now unblocked**, F2 is independently dependency-ready, and S3 remains gated on S2d. Every claim below was verified against source or execution — where documents disagreed, the code won (§1.4).
>
...
- **Track S — Simulation & data** (§4): the pipeline-driven engine overhaul. Stage 1 (implemented and accepted; **S1-R repair landed**) → Stage 2 (S2a/S2b/S2b-R/S2c1/S2c1-R done on an inactive candidate; S2c2/S2d remain) → Stage 3 (mechanics enabled by richer data). Strictly sequential within the track.
