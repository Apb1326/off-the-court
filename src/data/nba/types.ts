/**
 * TypeScript mirrors of the v3 normalized NBA data contracts produced by
...
export const NBA_DATA_SCHEMA_VERSION = 3;
...
export interface NbaDataManifest {
  ...
  /** False only for an intentional --allow-partial normalization. */
  complete: boolean;
