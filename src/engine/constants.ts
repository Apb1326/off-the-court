...
import type { RuntimeMatchupBucket } from '@/data/nba/position-mapping';
...
// BEGIN GENERATED S3B2 DEFENDER INFLUENCE
// Generated by scripts/derive-s3b2-defender-influence.ts from 2013-14 through 2024-25.
// Values are interior-defense weights in a raw perimeter/interior blend; sane range [0, 1].
export const S3B2_RIM_INTERIOR_WEIGHT = 0.933818;
export const S3B2_SHORT_MIDRANGE_INTERIOR_WEIGHT = 0.589576;
export const S3B2_SHARED_THREE_INTERIOR_WEIGHT = 0.000000;
...
// END GENERATED S3B2 DEFENDER INFLUENCE
